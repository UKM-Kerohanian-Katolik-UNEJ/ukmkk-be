                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a href="{{ route("admin.artikel.kometar", $content->slug) }}">
                                        <button
                                    ...
                                    <a href="{{ route("admin.artikel.edit", $content->slug) }}">
                                        <button
                                    ...
                                    <form id="hapus-konten" action="{{ route("admin.artikel.destroy", $content->slug) }}" method="post">
                                        @csrf
                                        @method("DELETE")
                                        <button type="button"
