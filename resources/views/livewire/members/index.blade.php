<div>
    <div class="flex flex-col lg:flex-row lg:justify-between items-center mb-3 gap-3">
        ...
        <div class="flex flex-col gap-3 items-center lg:flex-row">
            ...
            <select wire:model="tahun_masuk" class="select select-bordered w-[100px]">
                    ...
                    @foreach ($members as $member)
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-xs">
                                @if ($member->is_verified === "Pending")
                                    <span
                                    class="px-2 py-1 font-semibold leading-tight text-yellow-700 bg-yellow-100 rounded-full dark:bg-yellow-700 dark:text-yellow-100"
                                    >
                                @elseif($member->is_verified === "Verified")
                                    <span
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a href="{{ route("admin.anggota.show", $member->slug) }}">
                                        <button
                                    ...
                                    <form id="hapus-mahasiswa" action="{{ route("admin.anggota.destroy", $member->slug) }}" method="post">
                                        @csrf
                                        @method("DELETE")
                                        <button type="button"
